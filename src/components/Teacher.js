...
function Teacher() {
    ...
    const getCourses = async () => {
        let courses = await fetch('https://navigus-bquiz.herokuapp.com/getCourses').then(res => res.json()).then(data => {console.log('data', data);
        setCourseslist(data)}
        )
    ...
    const getQuestions= async()=>{
        let quizes=await fetch('https://navigus-bquiz.herokuapp.com/questions').then(res => res.json()).then(data => {console.log('data quiz data', data);
    getQuiz(data)}
        )
